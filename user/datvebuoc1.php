        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse pull-right">
                <ul class="nav" id="top-navigation">
                    <li class="active" style="margin-top: 25px; margin-right: 500px ;color: white;">Chọn lịch chiếu
                        phim
                    </li>
                </ul>
            </div>
                    ...
                    <table class="table">
                        ...
                        if ($ketqua) {
                         ...
                         width: 25px; height: 30px;"
                                    ...
                                    if (strtotime($dong["NGAYCHIEU"]) == $today && strtotime($dong["GIOCHIEU"]) >= $time) {
                                        ...
                                        echo     '<th>' . $dong["GIOCHIEU"] . '</th>';
                                        echo     '<th>' . $dong["PRICE"] . '</th>';
                                        echo     '<th><input name = "rd-mang[]" type="radio" id= "cb/' . $dong["MARAP"] . '/' . $dong["NGAYCHIEU"] . '/' . $dong["GIOCHIEU"] . '" style="width: 25px; height: 30px;"</th>';
                                        echo "</tr>";
                                        $count++;
