...
//duyệt từng dòng cho vào mảng
			...
			// ngược lại cho ra trang báo lỗi
			echo " <script> $('#btn-datve').click(function(){
					window.location.href='error.php';
				}); </script>";
		}
...
function HienThiChiTietPhim() {
	...
	if ($maphim != null) {
		// trường hợp gửi dữ liệu thất bại
