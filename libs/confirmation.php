...
<table border = "0" width="900" cellspacing = "0" cellpadding = "0">
    ...
    <tr>
        <td>
	        <form name = "form1" method = "POST" action = "paypal_entry.php">
                    ...
                    <td align = "left" valign = "top" class = "content4">
                        <table border = "0" width = "100%" cellspacing = "0" cellpadding = "0">
                            <tr>
                                ...
                                <div align= "left">
                                    <table border = "0" width = "98%" cellspacing = "0" cellpadding = "4" class = "content4" 
                                    style = "border:1px solid #333333; font-family:Verdana; font-size:8pt; color:#000000">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width = "65%" align = "left">
                                                ...
                                                <select name = "expDateYear" size = "1">
