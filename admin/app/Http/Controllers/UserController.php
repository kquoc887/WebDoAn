...
class UserController extends Controller
{
    ...
    public function postAdminLogin(Request $request)
    {
        ...
        $user = User::all();
        //duyệt từ đầu đến cuối trong bảng users của CSDL
        foreach ($user as $value) {
            //kiểm tra xem username người dùng nhập vào có bằng username nào trong bảng users hay không
            if (base64_decode($value->USER) == $username) {
                //kiểm tra xem password người dùng nhập vào có đúng hay không.
    ...
    public function logoutPageAdmin()
    {
