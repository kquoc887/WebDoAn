...
class UserController extends Controller
{
    ...
    public function get_User_Delete($id)
    {
        ...
        return redirect('PageAdmin/user/user_list')->with('thongbao',
            'Bạn đã xóa thành công'); // sau khi xóa xong trả về view danh sách user và xuất hiện một thông báo đã xóa thành công.
    }
    ...
    public function post_User_Add(Request $request)
    {
        ...
        return redirect('PageAdmin/user/user_add')->with('thongbao',
            'Bạn đã thêm thành công');//trả người dùng về giao diện thêm user và thông báo đã thêm thành công.
    }
