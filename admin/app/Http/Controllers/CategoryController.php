...
class CategoryController extends Controller
{
    ...
    public function getCategoryDelete($id)//$id ở đây là biến mã  loại phim
    {
    ...
    public function getCategoryEdit($id)////$id ở đây là biến mã  loại phim
    {
        $category = category::find($id);//tìm loại phim có mã tương ứng là $id
        return view('PageAdmin.category.category_edit', ['category' => $categogy]);// trả về view sữa thông tin loại phim và truyền một biên có tên là category qua view đó.
    }

    //hàm này được gọi khi ta bấm vào nút submit bên view sữa loại phim có tên là category_edit.blade.php.
    public function postCategoryEdit(Request $request,$id)//$id này là do được truyền khi bấm vào nút submit.
    {
